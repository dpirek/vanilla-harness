          ...
          this.createElement("form", { id: "presetEditorForm", class: "presetEditor", hidden: "", children: [
            ...
            this.createElement("section", { class: "presetEditorSection", children: [
              ...
              this.createElement("div", { class: "presetToggleGrid", "aria-label": "Tool permissions", children: [
                ...
                this.toggle("presetToolSearchSkills", "Search skills", "Discover guides by task and description"),
                this.toggle("presetToolReadSkillResource", "Read skill resources", "Load guides and supporting files when relevant"),
                ...
                this.toggle("presetToolDelegateToSubAgent", "Sub-agent delegation", "Run tasks on configured Agent Workers"),
              ] }),
            ] }),
            this.createElement("section", { class: "presetEditorSection", children: [
              this.createElement("div", { class: "presetSectionHeading", children: [
            ...
            this.createElement("section", { class: "presetEditorSection", children: [
              ...
              this.createElement("div", { id: "presetMcpAddForm", class: "presetMcpAddForm", children: [
                ...
                this.createElement("label", { id: "presetMcpHeadersField", children: [this.createElement("span", { children: [document.createTextNode("HTTP headers (one per line)")] }), this.createElement("textarea", { id: "presetMcpHeaders", rows: "3", spellcheck: "false", placeholder: "Authorization: Bearer ${MCP_TOKEN}" })] }),
