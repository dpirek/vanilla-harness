      ...
      return locked(async () => {
        ...
        for (const edit of edits) {
          ...
          if (Object.hasOwn(edit, 'old_text')) {
            if (before === null || typeof edit.old_text !== 'string' || !edit.old_text || typeof edit.new_text !== 'string') throw new Error('Exact edits require an existing file, nonempty old_text, and new_text.');
