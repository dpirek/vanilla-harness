...
- Use `references/latest-model.md` only as a disclosed fallback after current official model guidance does not answer the question. Read `references/model-migration.md` for an actual requested migration and `references/prompting-guide.md` only for requested prompting work.
