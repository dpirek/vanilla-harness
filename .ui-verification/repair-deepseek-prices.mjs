...
const provider = state.providers.find(p => p.id === "43bcef81-a8ca-4610-a438-a8eff48ab322");
if (!provider || new URL(provider.baseUrl).hostname !== "api.deepseek.com") throw new Error("DeepSeek provider not found");
const models = await enrichDeepSeekPrices(provider.models);
